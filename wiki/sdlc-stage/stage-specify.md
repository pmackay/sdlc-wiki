---
type: sdlc-stage
aka: { matt-pocock-skills: "to-spec", addy-agent-skills: "spec-driven-development / SPEC.md", openspec: "propose / spec deltas", speckit: "specify / spec.md", bmad: "Planning (PRD / UX / SPEC kernel)", gstack: "spec", bm-skills: "PRD Creator", nano-spec: "create / 4-doc pack", agent-os: "shape-spec" }
sources: "Synthesized from Matt Pocock + Addy Osmani + OpenSpec + Spec Kit + BMAD + gstack + BM Skills + nano-spec + Agent OS (2026)"
updated: 2026-08-05
---
