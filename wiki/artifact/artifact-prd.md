---
type: artifact
sources: "bmad-code-org/BMAD-METHOD (2026); Builder Methods — BM Skills (2026)"
updated: 2026-07-09
---
...
- [[bm-prd-creator]] — non-technical-builder interview → visual HTML PRD + milestone prompts.

## See Also
- [[artifact-spec-md]] — the leaner spec-document counterpart (Addy/SpecKit/BMAD/MP); MP's [[mp-to-spec]] now produces this instead of a PRD.
- [[artifact-issue]], [[artifact-story]] — the slices/stories decomposed from a PRD.
- [[artifact-product-brief]] — the pre-PRD scoping document (BMAD) that feeds it.
- [[pattern-spec-driven-development]] — the method this serves.
