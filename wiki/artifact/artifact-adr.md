---
type: artifact
sources: "Matt Pocock — Skills for Real Engineers (2026); tao-hpu/nano-spec (2025)"
updated: 2026-07-13
---
...
- [[nano-spec-create]] — the pack's `doc.md` Key Decisions (options considered · chosen · rationale); [[nano-spec-update]] appends new decisions as the build proceeds (part of the [[artifact-nano-spec-pack]]).
