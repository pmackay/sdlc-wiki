...
delegates_to: []
produces: []
applies: ["[[pattern-grilling]]", "[[pattern-persona-agents]]"]
equivalent_to: ["[[addy-idea-refine]]", "[[ce-ideate]]"]
sources: "bmad-code-org/BMAD-METHOD — bmad-brainstorming (2026)"
...
## See Also
- [[bmad]] — the framework.
- [[bmad-forge-idea]] — the adversarial counterpart: pressure-tests a chosen idea rather than generating options.
