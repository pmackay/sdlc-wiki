...
Spec Kit is the cluster's strictest on test-first: TDD is mandated by [[artifact-constitution|the constitution]], not merely encouraged — see [[pattern-test-driven-development]].
