...
BMAD's Analysis-phase research capability — three sibling skills dispatched by
[[bmad-analyst]], one page here since they share a workflow shape and all emit
...
Research grounds the align stage in evidence before a brief or PRD is written; its output "is
input" to the [[bmad-product-brief]] and [[bmad-prd]] workflows.
