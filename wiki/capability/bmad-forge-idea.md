...
applies: ["[[pattern-adversarial-review]]", "[[pattern-grilling]]"]
equivalent_to: []
sources: "bmad-code-org/BMAD-METHOD — bmad-forge-idea (2026)"
...
## See Also
- [[bmad]] — the framework.
- [[pattern-adversarial-review]] — the "reviewer must find issues" technique, here aimed at an idea.
- [[bmad-prfaq]] — a related working-backwards stress-test of a product concept.
