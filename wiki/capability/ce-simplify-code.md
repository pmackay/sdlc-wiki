...
`ce-simplify-code` ↔ [[addy-code-simplification]] (`equivalent_to`) — both reduce complexity while preserving exact behavior. Compound Engineering's twist is *placement*: a dedicated loop step between writing and review, feeding cleaner code into the persona fan-out.
